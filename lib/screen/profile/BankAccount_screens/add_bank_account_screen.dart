...
class AddBankScreenOnWithdraw extends StatefulWidget {
  const AddBankScreenOnWithdraw(
      {super.key});

  @override
  State<AddBankScreenOnWithdraw> createState() =>
      _AddBankScreenOnWithdrawState();
}

class _AddBankScreenOnWithdrawState extends State<AddBankScreenOnWithdraw> {
  final BankController _bankController = Get.put(BankController());
  final _fullName = TextEditingController();
  final _bankName = TextEditingController();
  final _ifsc = TextEditingController();
              ...
              LoginButton(
                  onTap: () {
                    if (_fullName.text.isNotEmpty &&
                        ...
                        _ifsc.text.isNotEmpty) {
                      if (_account.text == _accountConfirm.text) {
                        _bankController.addBankAcForWithdraw(
                            context,
                            _fullName.text,
                            _bankName.text,
                            _ifsc.text,
