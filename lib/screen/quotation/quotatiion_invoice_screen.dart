...
class QuotationInvoiceScreen extends StatefulWidget {
  const QuotationInvoiceScreen({super.key});
            ...
            child: Column(
              children: [
                ...
                InvoiceTile(
                    name: 'Size',
                    value:
                        '${_quotationController.heightI}cm x ${_quotationController.widthI}cm x ${_quotationController.lengthI}cm'),
                const SizedBox(height: 20),
                InvoiceTile(
                    name: 'Weight',
                    value: '${_quotationController.weightI} Kg'),
                const SizedBox(height: 20),
                const Divider(),
                const SizedBox(height: 20),
                InvoiceTile(
                ...
                InvoiceTile(
                    ...
                    value:
                        convertToCurrency(_quotationController.courierPrice)),
                const SizedBox(height: 20),
                InvoiceTile(
