...
class _TransactionListState extends State<TransactionList> {
  ...
  Widget build(BuildContext context) {
    return Obx(
        ...
        itemCount: _quotationController.getQuotationHistory.length,
          ...
          return InkWell(
            onTap: () {
              Get.to(
                    ...
                    store:
                    _quotationController.getQuotationHistory[index].store,
                    weight:
                    _quotationController.getQuotationHistory[index].weight,
                    height:
                    _quotationController.getQuotationHistory[index].height,
                    width:
                    _quotationController.getQuotationHistory[index].width,
                    price:
                    _quotationController.getQuotationHistory[index].price,
                    quantity: _quotationController
                        .getQuotationHistory[index].quantity,
                    video:
                    _quotationController.getQuotationHistory[index].video,
                    senderId: _quotationController.getQuotationHistory[index].senderId),
              );
            },
            child: Card(
              color: Colors.white,
